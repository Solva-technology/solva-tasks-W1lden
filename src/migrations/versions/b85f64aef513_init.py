...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("student", "teacher", "manager", "admin", name="userrole"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_tasks_group_id"), "tasks", ["group_id"], unique=False
    )
    op.create_index(op.f("ix_tasks_id"), "tasks", ["id"], unique=False)
    op.create_index(op.f("ix_tasks_status"), "tasks", ["status"], unique=False)
    op.create_index(
        op.f("ix_tasks_student_id"), "tasks", ["student_id"], unique=False
    )
